...
export const TimePicker = ({
  ...
  return (
    <div ref={containerRef} className="relative flex flex-1 flex-col gap-1">
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 z-50 -mb-5 flex w-[85%] max-w-[280px] flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg sm:left-auto sm:right-0 sm:w-[360px] sm:max-w-[420px] sm:flex-row">
          {/* Start Time Column */}
